...
console.log(ingredients(practiceIng));
...
let katniss = new Cat("Katniss", 12, "orange");
console.log(katniss.name);
...
let hermione = new Wizard("Hermione", 17, "Alohamora");
hermione.castSpell();
...
let phone1 = new Phone("Apple", "iPhone 12", 120, "gold", 500);
let phone2 = new Phone("Samsung", "Galaxy Note", 120, "black", 400);
let phone3 = new Phone("Motorolla", "Razor", 32, "silver", 120);
...
const myFirstVehicle = new Vehicle(4, "silver", 12000);
...
const myFirstMotorcycle = new Motorcycle(1, "black", 3000, "Yamaha", true);
...
const myFirstBoat = new Boat(12, "white", 2000, "Maribelle", "house boat", false)
